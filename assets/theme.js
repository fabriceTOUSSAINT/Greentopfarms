...
(function() {
  var Accordion, Collection, DOC, FrameworkAlign, FullscreenSlider, HorizontalTabs, MediaQueries, PAGE, Popup, ProductSlider, VerticalTabs, VideoModal, current_window, log, mq_large, mq_medium, mq_small, touchevents_exist,
  ...
  //   };
    ...
    // Removes opacity velocity on header
      ...
      DOC.on('change', '.tags-listbox', function() {
        ...
        if (newTags.length) {
          ...
          if (theme.collection.handle) {
            return window.location.href = theme.urls.collections + "/" + theme.collection.handle;
  ...
  theme.classes.ProductPage = (function() {
          ...
          theme.partials.Cart.addItem($(this), function(success, error) {
            if (success) {
              return theme.partials.Cart.updateAllHtml(function() {
                ...
                $(".add.font--button.bold_clone .text").text('✔ Added to cart');
				return;
                // TODO: Below is commented out to prevent opening the cart drawer when adding a product
                //                 return _this.addProductComplete();
              });
            } else {
    ...
    ProductPage.prototype.imageZoom = function() {
      ...
      if (active_zoom_image.length > 0) {
        ...
        return _this.media_container.on('mousemove', function(e) {
